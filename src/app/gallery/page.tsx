...
const galleryItems: GalleryItem[] = [
  ...
  { id: 4,  category: 'Stair Runners', label: 'Stair Runner — High Park',         image: '/images/project-stair-runner-high-park.jpg' },
  ...
  { id: 15, category: 'Hardwood', label: 'Hardwood — Yorkville',                  image: '/images/project-hardwood-yorkville-condo.jpg' },
  { id: 16, category: 'Hardwood', label: 'Hardwood — Forest Hill',                image: '/images/project-hardwood-forest-hill-full-home.jpg' },
  ...
  { id: 19, category: 'Hardwood', label: 'Hardwood — Etobicoke',                  image: '/images/project-hardwood-etobicoke-basement.jpg' },
  { id: 20, category: 'Hardwood', label: 'Hardwood — The Beaches',                image: '/images/project-hardwood-beaches-maple.jpg' },
  { id: 21, category: 'Hardwood', label: 'Hardwood — High Park',                  image: '/images/project-hardwood-high-park-walnut.jpg' },
  { id: 22, category: 'Hardwood', label: 'Hardwood — Rosedale',                   image: '/images/project-hardwood-rosedale-full.jpg' },
  ...
  // Luxury Vinyl
  { id: 25, category: 'Luxury Vinyl', label: 'Luxury Vinyl — Downtown',           image: '/images/project-vinyl-condo-downtown.jpg' },
  { id: 26, category: 'Luxury Vinyl', label: 'Luxury Vinyl — North York',         image: '/images/project-vinyl-north-york-basement.jpg' },
  ...
  { id: 29, category: 'Luxury Vinyl', label: 'Luxury Vinyl — Midtown',            image: '/images/project-vinyl-midtown-condo.jpg' },
  ...
  // Laminate
  { id: 34, category: 'Laminate', label: 'Laminate — Scarborough',                image: '/images/project-laminate-scarborough.jpg' },
  { id: 35, category: 'Laminate', label: 'Laminate — North York',                 image: '/images/project-laminate-north-york-basement.jpeg' },
  { id: 36, category: 'Laminate', label: 'Laminate — Etobicoke',                  image: '/images/project-laminate-etobicoke-bedroom.jpg' },
  { id: 37, category: 'Laminate', label: 'Laminate — Scarborough',                image: '/images/project-laminate-scarborough-rental.jpg' },
  { id: 38, category: 'Laminate', label: 'Laminate — East York',                  image: '/images/project-laminate-east-york-open-plan.jpg' },
  { id: 39, category: 'Laminate', label: 'Laminate — High Park',                  image: '/images/project-laminate-high-park-playroom.jpg' },
  // Carpet
