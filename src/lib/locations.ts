...
export const locations: Location[] = [
  ...
  },
  {
    ...
    name: "East York",
    description:
      "East York's charming older homes pair beautifully with refinished hardwood, new stair runners, and warm broadloom — all installed by Atlas's professional installers.",
  ...
  },
  {
    ...
    name: "Riverdale",
    description:
      "Riverdale's classic homes shine with refinished hardwood, new wood floors, and elegant stair runners — installed with care by Atlas's professional installers.",
